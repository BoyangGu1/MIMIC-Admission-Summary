...
def main():
    ...
    response_template: str = "the following is the golden brief hospital course section:"
    ...
    prompt: str = "extract the hospital courses of the following reports and summarize a brief hospital course section: {}\n the following is the golden brief hospital course section: {}"
    ...
    data_dict = load_datadict(mimic_version="mimic-iii",
                        heading_type="hpc",
                        tokenizer=tokenizer,
                        tokenizer_name=model_parameters.model_name.replace("/", "_"),
                        max_token_length=model_parameters.max_seq_length,
    ...
    # save model
    model.save_pretrained(os.path.join("unsloth_SFT_models", wandb_config.run_name))
    tokenizer.save_pretrained(os.path.join("unsloth_SFT_models", wandb_config.run_name))
